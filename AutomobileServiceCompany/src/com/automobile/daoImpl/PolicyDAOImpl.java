...
public class PolicyDAOImpl implements DAO<Policy> {
	...
	public int add(Policy policy) throws SQLException {
		...
		String sql = "Insert into policy_ag values(?,?,?)";
	...
	public int remove(long id) throws SQLException {
		...
		String sql = "delete from policy_ag where policyId = ?";
	...
	public int update(long id, String property, String newValue) throws SQLException {
		...
		String sql = "update policy_ag set " + property + "= ? where policyId = ? ";
	...
	public List<Policy> getAll() throws SQLException {
		...
		String sql = "select * from policy_ag";
	...
	public Policy get(long id) throws SQLException {
		...
		Policy policy= null;
		String sql = "select * from policy_ag where policyId = ?";
	...
	private Policy convertToObject(ResultSet rs) throws SQLException{
		...
		double premiumAmount = rs.getDouble("policyPremiumAmount");
