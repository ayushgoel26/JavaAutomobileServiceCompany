...
public class CustomerDAOImpl implements DAO<Customer> {
	...
	public int add(Customer cust) throws SQLException {
		...
		String sql = "Insert into customer_servicing_ag values(?,?,?)";
	...
	public int remove(long id) throws SQLException {
		...
		String sql = "delete from customer_servicing_ag where custId = ?";
	...
	public int update(long id, String property, String newValue) throws SQLException {
		...
		String sql = "update customer_servicing_ag set " + property + "= ? where custId = ? ";
	...
	public List<Customer> getAll() throws SQLException {
		...
		String sql = "select * from customer_servicing_ag natural join car_ag order by custName";
				...
				if(custList.size()>0){
					for(Customer customer : custList){
						...
						if (customer.getCustId()==(custId)){
							customer.addCar(new Car(carRegNum, carMake, carModel, policyId, custId));							
							exists = true;
	...
	public Customer get(long id) throws SQLException {
		...
		String sql = "select * from customer_servicing_ag natural join car_ag where custId = ?";
