...
public class ServiceDAOImpl implements DAO<Service> {
	...
	public int add(Service service) throws SQLException {
		...
		String sql = "Insert into services_ag values(?,?,?)";
	...
	public int remove(long id) throws SQLException {
		...
		String sql = "delete from services_ag where serviceId = ?";
	...
	public int update(long id, String property, String newValue) throws SQLException {
		...
		String sql = "update services_ag set " + property + "= ? where serviceId = ? ";
	...
	public List<Service> getAll() throws SQLException {
		...
		String sql = "select * from services_ag";
	...
	public Service get(long id) throws SQLException {
		...
		String sql = "select * from services_ag where serviceId = ?";
